...
public class MainActivity extends Activity {
   ...
   //  mImageView.setImageDrawable(test);
        ...
        protected Integer doInBackground(Integer... params) {
          ...
          /*  Bitmap testB = Bitmap.createBitmap(mBitmap);
           ...
           /* hsv_channel.get(1).setTo(new Scalar(hsvarray[1] * 100));
            ...
            Core.add(img, foreground, dst);//, mask);
    ...
    private class ProcessImageTask2 extends AsyncTask<Integer, Integer, Integer> {
    	Bitmap finalB = null;
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
        ...
        protected Integer doInBackground(Integer... params) {
            ...
            boolean status = help.cutImage(mBitmap, (int)tl.x, (int)tl.y,(int)br.x,(int)br.y);
            Log.d(TAG,"status = " + status);
            finalB = help.getBitmap_result();
            //Imgcodecs.imwrite(mCurrentPhotoPath + "_mod.png", dst);
        	} catch ( Exception e) {
        		e.printStackTrace();
        	}
